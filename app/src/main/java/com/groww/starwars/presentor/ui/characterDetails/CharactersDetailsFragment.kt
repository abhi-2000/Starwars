...
import com.groww.starwars.databinding.FragmentCharactersDetailsBinding
...
class CharactersDetailsFragment : Fragment() {
    ...
    private val filmsAdapter: CharacterDetailsFilmsAdapter by lazy {
        CharacterDetailsFilmsAdapter()
    }
